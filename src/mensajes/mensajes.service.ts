...
export class MensajesService {
    ...
    async updateMensaje(idMensaje:number,mensajeActualizar:CreateMensajeDto):Promise<Mensaje>{
        const mensajeUdpdate = await this.mensajeRepository.findOne(idMensaje);
        mensajeUdpdate.mensaje= mensajeActualizar.mensaje;
        mensajeUdpdate.nick= mensajeActualizar.nick;
        return await this.mensajeRepository.save(mensajeUdpdate);
  }
